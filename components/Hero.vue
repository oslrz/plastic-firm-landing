<template>
    <section class="">
      <div class="container mx-auto flex flex-row items-center py-16 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col">
          <h1 class="text-4xl font-extrabold text-gray-900 sm:text-5xl">
            Якісна плівка для будь-яких потреб
          </h1>
          <p class="mt-4 text-lg ">
            Виготовлення та продаж плівки для упаковки, будівництва та сільського господарства.
            Надійність, доступні ціни та швидка доставка.
          </p>
          <div class="mt-6">
            <a
              href="#products"
